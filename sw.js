...
const PRECACHE_LIST = [
  ...
  "./js/jquery.min.js",
  "./js/bootstrap.min.js",
  "./js/Fang-Li-blog.min.js",
  "./js/snackbar.js",
  "./img/icon_wechat.png",
  "./img/avatar-Fang-Li.jpg",
  "./img/home-bg.jpg",
  "./img/404-bg.jpg",
  "./css/Fang-Li-blog.min.css",
  "./css/syntax.css",
...
// Tracking https://twitter.com/Fang-Li/status/798816417097224193
...
function sendMessageToClientsAsync(msg) {
  ...
  // https://twitter.com/Fang-Li/status/799265578443751424

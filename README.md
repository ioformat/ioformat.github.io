...
###[View Live Fang-Li Blog &rarr;](https://huangxuan.me)
...
```
$ git clone git@github.com:Fang-Li/Fang-Liblog-boilerplate.git
```

**[View Boilerplate Here &rarr;](http://huangxuan.me/Fang-Liblog-boilerplate/)**


## Porting 

- [**Hexo**](https://github.com/Kaijun/hexo-theme-Fang-Liblog) by @kaijun
- [**React-SSR**](https://github.com/LucasIcarus/Fang-Li.github.io/tree/ssr) by @LucasIcarus

## Translation

 - ![cn](https://raw.githubusercontent.com/gosquared/flags/master/flags/flags/shiny/24/China.png) **Chinese (Simplified)**: 感谢 [@BrucZhaoR](https://github.com/BruceZhaoR) 的 [中文翻译 &rarr;](https://github.com/Fang-Li/Fang-Li.github.io/blob/master/README.zh.md)
...
- Fixed [issue#15](https://github.com/Fang-Li/Fang-Li.github.io/issues/15) about code wrap.
...
```
# Site settings
title: Fang-Li Blog             # title of your website
SEOTitle: Fang-Li Blog			# check out docs for more detail
description: "Cool Blog"    # ...

# SNS settings      
github_username: Fang-Li     # modify this account to yours
weibo_username: Fang-Li      # the footer woule be auto-updated.
...
sidebar-avatar: /img/avatar-Fang-Li.jpg     # use absolute URL.
```
...
Change header images of any pages or any posts is pretty easy as mentioned above. But, thanks to [issue #6 (in Chinese)](https://github.com/Fang-Li/Fang-Li.github.io/issues/6) asked, **how to make it looks great?**
...
It's possible that you want the two things different. For me, my site-title is **“Fang-Li Blog”** but I want the title shows in search engine is **“虫大侠的博客 | Fang-Li Blog”** which is multi-language.
...
Apache License 2.0.
Copyright (c) 2015-2016 Fang-Li

Fang-Li Blog is derived from [Clean Blog Jekyll Theme (MIT License)](https://github.com/BlackrockDigital/startbootstrap-clean-blog-jekyll/)
